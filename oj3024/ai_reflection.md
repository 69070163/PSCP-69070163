...
| OJ submission ID, if submitted | 566489 |
| OJ status | Pass |
...
```text
ฉันให้ AI ช่วยรีวิวแผนแรกที่ฉันทำ โดยที่ให้ AI หาข้อผิดพลาดและช่วยให้คำใบ้ในการแก้ไขโค้ด พร้อมกับลองเสนอ testcase ที่ช่วยฉันคาดการณ์ถึงขอบเขตของโค้ด
```
...
```text
AI ช่วยให้ฉันสังเกตแนวคิดอีกแบบหนึ่งที่เราสามารถคิดเพดานสูงสุดของ max และ min ของคะแนนได้ เปลี่ยนจาดวิธีการเดิมของฉันที่ใช้ sum - max แล้วนำไปหารสอง และAI ช่วยให้ฉันสังเกตความครอบคลุมของโค้ดในกรณีที่ min = 0 หรือผลโหวตทั้งหมด = 0 ด้วยเช่นกัน โดยที่ถ้าผลโหวตติดลบ ต้องทำให้ min เป็น 0 ต้องนำไปลบการค่ามากสุดอยู่ดี
```
...
```text
ฉันแก้ไขโค้ดทั้งหมดด้วยตนเอง ทั้งวางโครงสร้างใหม่ ทดสอบใน VSCode เอง แก้ไขตาม testcase ที่ AI แนะนำเอง
```
...
```text
ฉันได้เรียนรู็เกี่ยวกับวิธีการคิดของโจทย์ข้อนี้ที่ทำโดยการให้ค่ามากสุดมีทั้งหมด 2 ตัว เพื่อที่จะหาความเป็นไปได้น้อยสุด ของค่าน้อยที่สุด จากแนวคิดนี้ทำให้ฉันได้ลองแก้ไขโค้ดของตนเองตามที่ AI แนะนำ และได้เรียนรู็เเกี่ยวกับการคาดการณ์ testcase ที่อยู๋นอกเหนือจาก sample testcase เช่นกรณีที่คะแนนน้อยสุด น้อยกว่า 0 หรือเท่ากับ 0
```
