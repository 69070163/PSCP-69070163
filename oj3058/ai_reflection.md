...
| OJ submission ID, if submitted | 631892 |
| OJ status | Pass |
...
```text
ฉันให้AI ช่วยไกด์โจทย์เพิ่มเติมให้จากการที่ตอนแรกฉันถามเพื่อนแล้วยังไม่เข้าใจ และช่วย debug code ที่ฉันเขียนไปตอนแรก
```
...
```text
AIช่วยให้ฉันเห็นว่า ยังมีอีกกรณีนึงที่ฉันคิดไม่ถึง ก็คือ ถ้ามีอิฐใหญ่เกินกว่าที่ใช้ ต้องแบ่งเป็นอีก 2 กรณีแยกย่อย
```
...
```text
ฉันแก้ไขโค้ดด้วยตนเอง และทำความเข้าใจจากวิธีที่เอไอใบ้มา รวมถึงกลับไปอ่านโจทย์ซ้ำอีกหลายๆรอบ เพื่อรีเช็คตัวเอไอ
```
...
```text
ฉันได้เรียนรู้ว่า ควรมองโจทย์ข้อนี้ให้กว้างกว่าที่โจทย์ให้มา จาก sample testcase ที่โจทย์กำหนดให้ รวมถึงการแบ่งการคิดเป็นช่วงๆ ใช้วิธีพื้นฐาน แทนที่จะใช้แต่ฟังก์ชันอย่างที่เอไอใบ้มา
```
