...
```text
input:
รับข้อความ 1 ข้อความ เป็น string

output:
แสดงสระที่นับได้ 

Constraints:
ที่นับแค่สระที่มีเท่านั้น
```
...
```text
step 1: รับข้อความเป็น string 1 ข้อความ ใช้ฟังก์ชัน .lower เพื่อให้ทุกตัวอักษรเป็นตัวพิมพ์เล็ก
step 2: สร้างตัวแปรเก็บจำนวนสระ 5 ตัว (เรียง aeiou)
step 3: ใช้ for loop เช็คตัวอักษรในตัวแปรที่รับข้อความ
step 4: ใช้ if-else เช็คค่าใน for loop ถ้าเจอตัวอักษรตัวไหน ให้บวกเพิ่มตัวนั้น
step 5: ใช้ if else เช็คว่าถ้ามีสระตัวนี้ในตัวแปรที่รับค่า ให้แสดงว่ามีสระนั้นมีกี่ตัว
```
...
```text
วิธีสุดท้ายของฉันคือแบบเดียวกับแผนแรกของฉันเลย
```
...
```text
ทดสอบว่าถ้าพิมพ์ตัวพิมพ์ใหญ่ไป code จะทำงานได้มั้ย
```
...
```text
ถ้าไม่มีสระเลย output ต้องว่างเปล่า
```
