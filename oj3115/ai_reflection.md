...
| OJ submission ID, if submitted | 633596 |
| OJ status | Pass |
...
```text
ให้ AI ช่วยอธิบายโจทย์ในส่วนที่ฉันยังสับสนอยู่ เช่นฉันยังสับสนเรื่องการ input เข้ามาว่าต้องใช้รับเข้ายังไงให้ตรงกับ input ของโจทย์ จากนั้นหลังจากที่ฉันลองเขียนเองแล้วติดปัญหาเรื่อง run time ฉันเลยมาขอไกด์อีกรอบ ฉันยังถามเพิ่มเติมด้วยว่าทำไมวิธีนี้ถึงได้ผล แล้วนำไปปรับใช้
```
...
```text
AI ช่วยแนะนำวิธีที่ฉันได้รับคำแนะนำมาจากเพื่อนอีกที ให้ฉันรู้ว่าเราสามารถใช้ index ของ list มาใช้เช็คแทนการใช้ if-else ปกติได้
```
...
```text
ฉันนำวิธีที่ AI และเพื่อน แนะนำมาปรับใช้กับโค้ดของตัวเอง จากนั้นฉันก็ลองเขียนส่วนที่เหลือด้วยตนเองและวิธีที่ AI แนะนำมา ไม่ถูก pep-8 ฉันก็เลยไปแก้ pep-8 ด้วยตนเอง
```
...
```text
ฉันได้เรียนรู้เกี่ยวกับการนำ list มาใช้ และการใช้ index ของ list ในการตรวจสอบ แทนที่จะใช้การคำนวณตรงๆ เพื่อป้องกันการเกิด run time error จาก testcase ที่เยอะเกิน
```
