...
```text
Input:
รับค่าความยาวการกระโดดรอบแรกของกบน้อย เป็น x และระยะปลายทางเป็น y

Output:
จำนวนครั้งที่กระโดดหรือ -1 ถ้าไปไม่ถึง

Constraints:
การที่กบน้อยกระโดดแต่ละที น้องจะกระโดดน้อยลดลงทีละ 2 เมตร 
```
...
```text
step1 : รับค่า x และ y 
step2 : สร้างตัวแปร hop_to_goal = 0 และ times = 0 ตัวแรกเพื่อวัดระยะทาง อีกตัวเพื่อดูว่ากบน้อยกระโดดกี่ครั้ง
step3 : จากนั้นใช้ while loop ในเงื่อนไขที่ ถ้า hop to goal <= y ก็คือยังไม่ถึงปลายทาง กบน้อยจะค่อยๆสะสม hop to goal ไปเรื่อยๆ และในแต่ละลูป x จะลดลงทีละ 2 และ timeจะบวกทีละ 1
step4 : สร้างเงื่อนไขกรณีที่ต้องออกจากลูป ได้แก่ x เป็น 0 หรือ กบน้อยกระโดดถึงเป้าแล้ว และ x น้อยกว่า 0
step5 : แสดงผลภายใต้เงื่อนไขที่ ถ้า hop tp goal >= y แสดงว่ากบน้อยกระโดดผ่าน เลยแสดงผลครั้งที่กระโดด แต่ถ้าไม่ใช่ให้แสดง -1
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรกเลย ฉันใช้ while loop ในการคำนวนรอบกระโดดของกระต่ายน้อย
```
...
```text
แนะนำว่าควรใช้ while loop แทน for loop
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนเงื่อนไขใน while loop
```
