...
```text
Input:
รับค่าของเลขบนไพ่ หรือลำดับ j q k a และดอกไพ่ ในบรรทัดเดียวกัน

Output:
พิมพ์ชื่อเต็มของไพ่ใบนั้น

Constraints:
สามารถ input ได้ทั้งพิมพ์ใหญ่พิมพ์เล็ก
```
...
```text
 step1 :  รับไพ่ที่ได้ จากนั้นเช็ค if-else ว่ามีความยาวของ string เท่ากับ 3 หรือไม่ ถ้าเท่าแปลว่าไพ่ใบนั้นเป็นไพ่เลข 
step2 : แต่ถ้าไม่เท่า ให้เก็บค่าว่าค่าของไพ่ใบนั้นที่เป็น a j q k เป็นใบไหนในนี้
step3 : จากนั้นดูดอกไพ่ ลงดอกไหนก็เก็บค่าไว้
step4 : ตอน print ใช้ f-string แยก ค่าบนไพ่กับดอกไพ่
```
...
```text
ในขั้นตอนแรกที่ฉันทำ ฉันลืมว่า ไพ่ที่มีค่าแค่หลักเดียวก็มี ฉันเลยเพิ่ม else ในตอนที่ตรวจเช็คค่าไพ่ของไพ่ a j q k ด้วยการเปลี่ยนค่า index แรกของ input ที่รับมาเป็น int
```
...
```text
ทดสอบค่าไพ่ที่เป็นเลขหลักเดียว
```
...
```text
ให้คำแนะนำว่าควรใช้ if-else แทน dict เพราะง่ายกว่า
```
