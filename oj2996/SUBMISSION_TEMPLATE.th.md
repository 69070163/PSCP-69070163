...
output : 
ข้อความนั้นต้องสลับหลังมาหน้า โดยที่ข้อความนั้น สามารถมีช่องว่าง และต้องเป็นตัวพิมพ์เล็กเท่านั้น 

constraints : 
การ output ออกมากลับหลังมาหน้า และต้องเป็นตัวพิมพ์เล็กทั้งหมดดังนั้นต้องใช้ string method ร่วมด้วย
...
```text
Step 1: สร้างตัวแปร text รับ input ชื่อเป็น string
Step 2: ใช้ฟังก์ชั่น .lower() หลัง input เพื่อให้ text เก็บค่า string เป็นตัวพิมพ์เล็กทั้งหมด
Step 3: ใช้คำสั่ง print text โดยที่จะใช้ string slicing ในขั้นตอน step เป็นลบ 1 เพื่อให้ข้อควมกลับหลังมาหน้า
```
...
```text
เหมือนกัน เพราะคิดว่าแผนนี้น่าจะเวิร์คและประหยัดบรรทัดที่สุด
```
...
```text
ทำทุกขั้นตอนด้วยตนเอง
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนและทดสอบโค้ดด้วยตนเอง และส่งลง oj ด้วยตนเอง
```
