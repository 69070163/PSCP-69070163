...
| OJ submission ID, if submitted | 581040 |
| OJ status | Pass |
...
```text
ฉันถาม AI ให้ช่วย review แผนของฉัน และช่วยตรวจทานสมการที่ฉันทำการกลับข้าง จากสูตรที่โจทย์กำหนดให้ รวมถึงคำใบ้เกี่ยวกับ testcase ที่ฉันยังไม่ผ่าน
```
...
```text
AI ช่วยให้ฉันสังเกตุว่าฉันย้ายข้างสมการผิดจริงๆ ตรงหน่วย Rankine และให้คำแนะนำกับ testcase ที่อุณหภูมิเปลี่ยนเป็นหน่วยเดิม 
```
...
```text
ฉันแก้ไขสมการด้วยตนเอง และเพิ่มเงื่อนไขให้ครบถ้วนยิ่งขึ้น จากนั้นทดลองรันใน VS code ด้วยตนเอง
```
...
```text
ฉันได้เรียนรู้ว่าฉันควรคิดถึงทุก testcase ที่อาจเป็นไปได้ นอกเหนือจากโจทย์ให้มา และทบทวนการใช้วงเล็บในการคำนวนให้ได้ผลลัพธ์ตรงตามที่โจทย์ต้องการ
```
